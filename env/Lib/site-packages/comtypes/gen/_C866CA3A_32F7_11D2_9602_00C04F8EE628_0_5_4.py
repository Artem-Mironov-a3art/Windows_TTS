...
__all__ = [
    'DISPID_SPIGetDisplayAttributes', 'SPLEXICONTYPE',
    'DISPID_SGRSTs_NewEnum', 'SPEI_SENTENCE_BOUNDARY',
    'SPBINARYGRAMMAR', 'ISpeechPhraseRules', 'DISPID_SABIEventBias',
    'DISPID_SpeechPhraseElement', 'SGLexical', 'ISpMMSysAudio',
    'ISpeechXMLRecoResult', 'SPAS_STOP', 'SpeechRecoEvents',
    'SAFT12kHz16BitStereo', 'DISPID_SWFEBitsPerSample',
    'DISPID_SRRTStreamTime', 'SpMemoryStream', 'SGRSTTEpsilon',
    'SPSHT_Unknown', 'SPDKL_CurrentUser', 'SpFileStream',
    'ISpeechLexicon', 'DISPID_SPRuleName', 'SGSEnabled',
    'DISPID_SBSSeek', 'SGDSInactive', 'DISPID_SGRsCount',
    'SAFT8kHz16BitMono', 'SpeechMicTraining',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'DISPID_SPIRetainedSizeBytes', 'SPINTERFERENCE_NOISE',
    'ISpObjectToken', 'SAFT22kHz8BitStereo', 'SAFT12kHz8BitMono',
    'ISpRecognizer', 'SAFT32kHz8BitStereo', 'DISPID_SVSPhonemeId',
    'STCInprocServer', 'SREHypothesis', 'DISPID_SLPsCount',
    'ISpeechAudio', 'DISPID_SLGetPronunciations', 'SPVPRI_NORMAL',
    'SVEEndInputStream', 'SREFalseRecognition', 'DISPID_SRGRules',
    'DISPID_SRSetPropertyString', 'SP_VISEME_3', 'DISPID_SVDisplayUI',
    'DISPID_SGRAddState', 'DISPID_SPPParent',
    'DISPID_SpeechXMLRecoResult', 'DISPID_SGRSTPropertyValue',
    'ISpStream', 'SAFTText', 'SPSHORTCUTTYPE',
    'SAFTCCITT_ALaw_8kHzMono', 'ISpeechPhraseProperty',
    'SPEI_RECO_STATE_CHANGE', 'ISpPhoneticAlphabetSelection',
    'SVEAudioLevel', 'STCRemoteServer', 'SASClosed', 'SpMMAudioIn',
    'DISPID_SDKSetLongValue', 'SPBO_TIME_UNITS',
    'DISPID_SPPNumberOfElements', 'SPRST_INACTIVE_WITH_PURGE',
    'SVP_0', 'SPEI_START_SR_STREAM', 'ISpeechPhraseReplacement',
    'DISPID_SOTCGetDataKey', 'SAFTCCITT_uLaw_8kHzMono',
    'DISPID_SWFEExtraData', 'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SLPPartOfSpeech', 'DISPID_SAEventHandle',
    'DISPID_SPPsCount', 'SRTAutopause', 'DISPID_SPISaveToMemory',
    'eLEXTYPE_PRIVATE17', 'DISPID_SVVoice', 'DISPID_SDKEnumKeys',
    'SAFTNoAssignedFormat', 'DISPID_SRCSetAdaptationData',
    'DISPID_SOTGetStorageFileName', 'DISPID_SOTsItem',
    'DISPID_SRCERecognizerStateChange', 'STSF_FlagCreate',
    'ISpEventSink', 'SRARoot', 'SP_VISEME_18',
    'SpeechPropertyResourceUsage', 'eLEXTYPE_PRIVATE19',
    'DISPID_SVSInputSentencePosition', 'ISpeechPhraseElements',
    'DISPID_SRCPause', 'SAFTCCITT_ALaw_44kHzMono', 'SREInterference',
    'DISPID_SRGCmdSetRuleState', 'SPSEMANTICFORMAT',
    'DISPID_SRGetPropertyString', 'DISPID_SRGSetWordSequenceData',
    'DISPID_SPERetainedStreamOffset', 'SPAUDIOOPTIONS',
    'DISPID_SOTRemove', 'DISPID_SPRuleId', 'SPPHRASEREPLACEMENT',
    'DISPID_SADefaultFormat', 'DISPID_SMSGetData',
    'DISPID_SPCIdToPhone', 'eLEXTYPE_MORPHOLOGY',
    'ISpeechRecoContext', 'SAFTCCITT_uLaw_11kHzMono',
    'SpeechPropertyNormalConfidenceThreshold', 'SAFT12kHz8BitStereo',
    'SpeechVoicePriority', 'DISPID_SRGSetTextSelection',
    'tagSPPROPERTYINFO', 'SPINTERFERENCE_TOOFAST', 'SDKLLocalMachine',
    'DISPID_SVESentenceBoundary', 'DISPID_SLGetGenerationChange',
    'DISPIDSPTSI', 'ISpeechPhraseAlternate',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SRRPhraseInfo',
    'SPAR_Medium', 'SPRS_ACTIVE', 'DISPID_SGRSTNextState',
    'SGLexicalNoSpecialChars', 'SpeechCategoryAudioOut', 'SPSNoun',
    'DISPID_SVSInputWordLength', 'DISPID_SVEStreamStart',
    'DISPID_SRCEEndStream', 'SPEI_HYPOTHESIS', 'SPEVENT',
    'DISPID_SGRSTWeight', 'DISPID_SWFEAvgBytesPerSec',
    'SpeechRecognitionType', 'SpeechRuleState', 'eLEXTYPE_PRIVATE8',
    'SPEI_SR_BOOKMARK', 'SP_VISEME_20', 'DISPID_SLPsItem',
    'eLEXTYPE_PRIVATE15', 'ISpeechLexiconPronunciation',
    'DISPID_SMSAMMHandle', 'SP_VISEME_7', 'ISpeechPhraseInfoBuilder',
    'DISPID_SGRName', 'DISPID_SRRAlternates',
    'DISPID_SPRules_NewEnum', 'SVP_7', 'SDTProperty', 'SVP_14',
    'SpeechRecognizerState', 'SRTReSent',
    'DISPID_SVSLastStreamNumberQueued', 'SPDKL_CurrentConfig',
    'DISPID_SGRSTransitions', 'SpCustomStream',
    'DISPID_SRCEPhraseStart', 'SPPS_RESERVED2', 'SPEI_TTS_BOOKMARK',
    'SDA_One_Trailing_Space', 'DISPID_SOTCreateInstance',
    'SECHighConfidence', 'DISPID_SOTsCount', 'SAFT11kHz16BitStereo',
    'ISpLexicon', 'SAFT8kHz8BitStereo',
    'SpeechRegistryLocalMachineRoot',
    'SpeechGrammarRuleStateTransitionType',
    'DISPID_SRRDiscardResultInfo', 'eLEXTYPE_PRIVATE5',
    'DISPID_SRCEFalseRecognition', 'SpeechRunState', 'SBONone',
    'DISPID_SRRSaveToMemory', 'SAFT44kHz16BitStereo',
    'DISPID_SpeechPhraseRules', 'SPRULE', 'SpeechInterference',
    'DISPID_SGRSTType', 'SAFT11kHz16BitMono', 'SASRun',
    'WAVEFORMATEX', 'eLEXTYPE_PRIVATE2', 'DISPID_SABIMinNotification',
    'SVSFIsXML', 'SpeechTokenKeyUI', 'SAFT8kHz8BitMono',
    'DISPID_SRIsUISupported', 'eLEXTYPE_RESERVED10',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SECFDefault', 'DISPID_SOTId',
    'DISPID_SpeechAudioFormat', 'ISpPhoneticAlphabetConverter',
    'eWORDTYPE_DELETED', 'DISPID_SpeechRecoContextEvents',
    'DISPID_SDKDeleteValue', 'SpeechDisplayAttributes', 'SPSLMA',
    'SRERequestUI', 'DISPID_SGRsDynamic', 'SpInProcRecoContext',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SRDisplayUI',
    'DISPID_SPARecoResult', 'SPFM_OPEN_READONLY',
    'DISPID_SGRInitialState', 'DISPID_SPPValue',
    'DISPID_SRSAudioStatus', 'DISPID_SVEStreamEnd',
    'DISPID_SPPConfidence', 'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SVP_4',
    'SVP_11', 'DISPID_SDKGetStringValue', 'SECFIgnoreWidth',
    'DISPID_SOTMatchesAttributes', 'SPCT_SUB_COMMAND', 'SPWT_DISPLAY',
    'DISPID_SpeechPhraseAlternates', 'SpeechVisemeFeature',
    'DISPID_SASCurrentDevicePosition', 'SPCT_SUB_DICTATION',
    'SPEI_ADAPTATION', 'SP_VISEME_11', 'DISPID_SVGetVoices',
    'DISPID_SRCEPropertyNumberChange',
    'SpeechCategoryPhoneConverters', 'DISPID_SASState',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SLGetWords',
    'DISPID_SRSCurrentStreamNumber', 'SPSVerb',
    'SpUnCompressedLexicon', 'SpeechVisemeType', 'SpMMAudioEnum',
    'DISPID_SRCEAdaptation', 'DISPID_SpeechRecoResult', 'SPSHT_EMAIL',
    'SRADynamic', 'SAFT22kHz16BitMono', 'DISPID_SpeechObjectToken',
    'IInternetSecurityMgrSite', 'DISPID_SRRSpeakAudio',
    'DISPID_SOTIsUISupported', 'ISpeechGrammarRule',
    'SAFT11kHz8BitMono', 'SPSERIALIZEDPHRASE', 'SPPS_NotOverriden',
    'SRAORetainAudio', 'DISPID_SGRs_NewEnum', 'SPWORDTYPE',
    'ISpRecoCategory', 'DISPID_SRGetFormat', 'SVP_18',
    'ISpeechWaveFormatEx', 'DISPID_SRSClsidEngine',
    'DISPID_SDKCreateKey', 'SDTLexicalForm',
    'DISPID_SDKSetStringValue', 'DISPID_SPRuleConfidence',
    'SAFTCCITT_uLaw_22kHzMono', 'SVF_Emphasis',
    'SpeechBookmarkOptions', 'SVP_3', 'SpeechAudioFormatGUIDText',
    'Speech_Max_Pron_Length', 'DISPID_SAFGuid',
    'DISPID_SRCEStartStream', 'SSSPTRelativeToStart', 'SLOStatic',
    'ISpeechObjectTokenCategory', 'SPCS_DISABLED',
    'DISPID_SRGDictationLoad', 'SPDATAKEYLOCATION',
    'DISPID_SRRTTickCount', 'SRTExtendableParse',
    'DISPID_SRCEBookmark', 'DISPID_SVSyncronousSpeakTimeout',
    'ISpeechRecoResult2', 'DISPID_SpeechRecognizer', 'SPPHRASERULE',
    'ISpeechFileStream', 'DISPID_SBSFormat', 'SPBO_NONE',
    'SDTPronunciation', 'ISpeechGrammarRuleState', 'SPCT_COMMAND',
    'SFTSREngine', 'ISpRecoGrammar2', 'DISPID_SRGCommit',
    'DISPID_SpeechPhraseProperties', 'SPFILEMODE',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SVEWord',
    'SpeechCategoryAudioIn', 'SP_VISEME_4',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SOTCategory',
    'ISpeechGrammarRules', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SVP_10', 'SINoSignal', 'DISPID_SPIEngineId', 'SPPS_RESERVED4',
    'SpShortcut', 'LONG_PTR', 'SPFM_CREATE', 'DISPID_SPEsItem',
    'SpeechLexiconType', 'ISpeechRecognizer', 'DISPID_SOTSetId',
    'SPXRO_Alternates_SML', 'SVSFlagsAsync', 'SRAImport',
    'DISPID_SPAs_NewEnum', 'DISPID_SpeechPhraseBuilder',
    'DISPID_SPEsCount', 'SVF_Stressed', 'ISpeechObjectToken',
    'SpeechAudioVolume', 'SPFM_OPEN_READWRITE',
    'DISPID_SOTGetDescription', 'SASStop', 'eWORDTYPE_ADDED',
    'ISpRecoContext2', 'DISPID_SpeechRecognizerStatus',
    'DISPID_SRGReset', 'ISpShortcut', 'DISPID_SPRulesItem',
    'SP_VISEME_6', 'SECLowConfidence', 'SRCS_Enabled',
    'SAFTCCITT_uLaw_44kHzStereo',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'DISPID_SGRSTsItem',
    'DISPID_SRState', 'SINoise', 'SPFM_CREATE_ALWAYS',
    'SAFTNonStandardFormat', 'DISPID_SPILanguageId',
    'DISPID_SOTCDefault', 'SVP_8', 'SPWORDPRONUNCIATIONLIST',
    'SINone', 'SPEI_RESERVED5', 'SpeechRetainedAudioOptions',
    'DISPID_SVSLastBookmark', 'SGSDisabled',
    'DISPID_SpeechMMSysAudio', 'SpLexicon',
    'DISPID_SpeechPhraseProperty', 'SpeechPropertyAdaptationOn',
    'SP_VISEME_13', 'SPEI_INTERFERENCE', 'DISPID_SGRsAdd',
    'SpeechUserTraining', 'SAFT24kHz8BitMono', 'SFTInput',
    'DISPID_SRCESoundStart', 'DISPID_SpeechObjectTokens', 'SVP_2',
    'DISPID_SLPs_NewEnum', 'SPSSuppressWord', 'SDKLDefaultLocation',
    'ISpeechVoice', 'DISPID_SRGCmdLoadFromObject',
    'DISPID_SRRGetXMLResult', 'DISPID_SPANumberOfElementsInResult',
    'ISpeechObjectTokens', 'ISpeechPhraseProperties',
    'DISPID_SPELexicalForm', 'SDTReplacement', 'SVSFParseMask',
    'SpeechWordPronounceable', 'SVEPrivate', 'DISPID_SPPName',
    'SVEAllEvents', 'DISPID_SRSSupportedLanguages',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SPEs_NewEnum',
    'DISPID_SOTDisplayUI', 'DISPID_SVGetAudioOutputs', 'SVSFNLPMask',
    'DISPID_SVEPhoneme', 'Speech_Max_Word_Length',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SRCRecognizer', 'SWTAdded',
    'SPWF_SRENGINE', 'DISPID_SRCRequestedUIType', 'SPAUDIOSTATUS',
    'DISPID_SRRSetTextFeedback', 'SLTUser', 'DISPID_SVAudioOutput',
    'SPSERIALIZEDRESULT', 'DISPID_SRGCmdLoadFromFile',
    'DISPID_SPEEngineConfidence', 'SVEWordBoundary',
    'SpeechDataKeyLocation', 'DISPID_SRCVoicePurgeEvent',
    'STSF_CommonAppData', 'SITooSlow', 'DISPID_SRRTOffsetFromStart',
    'DISPID_SRSNumberOfActiveRules', 'SVP_13',
    'SGDSActiveWithAutoPause', 'SVPAlert', 'SAFTADPCM_8kHzStereo',
    'ISpResourceManager', 'SWPUnknownWordUnpronounceable', 'SBOPause',
    'SAFT22kHz16BitStereo', 'SPPS_LMA', 'eLEXTYPE_RESERVED4',
    'ISpeechBaseStream', 'SRSInactiveWithPurge', 'SITooLoud',
    'DISPID_SpeechPhraseRule', 'DISPID_SGRSTsCount', 'ISpeechDataKey',
    'SRERecognition', 'ISpPhoneConverter', 'SRTSMLTimeout',
    'ISpeechAudioBufferInfo', 'SPEI_MAX_TTS', 'SREPhraseStart',
    'IEnumString', 'DISPID_SLWsCount', 'SPAS_PAUSE',
    'DISPID_SPAsItem', 'DISPID_SRCBookmark', 'DISPID_SWFEFormatTag',
    'SREBookmark', 'SDTDisplayText', 'SVESentenceBoundary',
    'SPBO_AHEAD', 'eLEXTYPE_PRIVATE6', 'SPSTREAMFORMATTYPE',
    'Speech_StreamPos_Asap', 'DISPID_SVSCurrentStreamNumber',
    'SpResourceManager', 'DISPID_SRCEPropertyStringChange',
    'SpeechFormatType', 'SECFNoSpecialChars', 'DISPID_SPRuleChildren',
    'DISPID_SDKSetBinaryValue', 'SAFT32kHz16BitStereo',
    'ISpeechPhoneConverter', 'SDA_No_Trailing_Space',
    'DISPIDSPTSI_ActiveOffset', 'SPBOOKMARKOPTIONS',
    '__MIDL_IWinTypes_0009', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SSFMCreate', 'SP_VISEME_17', 'DISPID_SDKDeleteKey',
    'SPRST_ACTIVE', 'DISPID_SMSADeviceId',
    'SpeechGrammarTagUnlimitedDictation', 'SpeechTokenIdUserLexicon',
    'ISpeechRecoResult', 'DISPID_SVEEnginePrivate', 'SVP_9',
    'DISPID_SRRGetXMLErrorInfo',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SRGIsPronounceable', 'SAFTCCITT_uLaw_11kHzStereo',
    'DISPID_SLPSymbolic', 'SPPS_Interjection', 'DISPID_SPPChildren',
    'ISpNotifySink', 'SpeechStreamSeekPositionType',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SPIAudioStreamPosition',
    'SREStateChange', 'ISpStreamFormat', 'ISpStreamFormatConverter',
    'SpeechEngineConfidence', 'SPWORDPRONUNCIATION',
    'SPAUDIOBUFFERINFO', 'SPEI_PHONEME', '_ISpeechVoiceEvents',
    'DISPID_SVEBookmark', 'SpeechCategoryVoices',
    'ISpeechTextSelectionInformation', 'SREAudioLevel', 'SRAExport',
    'SPPS_Function', 'DISPID_SpeechGrammarRuleState',
    'DISPID_SRCEInterference', 'SVSFDefault', 'SPWF_INPUT',
    'DISPID_SpeechVoiceEvent', 'DISPID_SOTCId', 'SP_VISEME_21',
    'SpeechTokenKeyFiles', 'SPCONTEXTSTATE', 'DISPID_SPRText',
    'SAFTCCITT_ALaw_22kHzStereo',
    'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SpeechLexiconProns', 'SITooQuiet',
    'DISPID_SGRSAddRuleTransition', 'SVPOver', 'ISpGrammarBuilder',
    'DISPID_SPEActualConfidence', 'ISpSerializeState',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'ISpDataKey', 'SPVOICESTATUS',
    'SAFT48kHz16BitStereo', 'DISPID_SLPType', 'SPEI_MIN_TTS',
    'SPEI_RESERVED3', 'DISPID_SDKGetBinaryValue',
    'eLEXTYPE_USER_SHORTCUT', 'DISPID_SAStatus',
    'DISPID_SpeechLexiconPronunciation', 'ISpRecognizer3',
    'DISPID_SPIGetText', 'SRAInterpreter', 'DISPID_SRRTimes',
    'SVEStartInputStream', 'SAFTADPCM_11kHzMono',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SGRSTText',
    'DISPID_SVPriority', 'SAFTGSM610_22kHzMono', 'UINT_PTR',
    'ISpRecoGrammar', 'SpeechEmulationCompareFlags', 'DISPID_SFSOpen',
    'SpCompressedLexicon', 'SpeechPropertyResponseSpeed',
    'SWPUnknownWordPronounceable', 'SpeechTokenContext',
    'SAFTGSM610_11kHzMono', 'SAFTGSM610_8kHzMono', 'SASPause',
    'SPPHRASE', 'DISPID_SGRAddResource', 'ISpeechCustomStream',
    'DISPID_SWFEChannels', 'DISPID_SpeechPhraseAlternate', 'SVP_20',
    'DISPID_SpeechGrammarRules', 'SpeechAudioFormatGUIDWave',
    'SPEI_RECO_OTHER_CONTEXT', 'ISpeechPhraseAlternates',
    'SPWT_LEXICAL', 'ISpAudio', 'SP_VISEME_10', 'DISPID_SRRAudio',
    'ISpeechRecoResultTimes', 'SVSFNLPSpeakPunc',
    'SAFTGSM610_44kHzMono', 'DISPID_SOTDataKey',
    'SpeechRegistryUserRoot', 'eLEXTYPE_RESERVED8',
    'DISPID_SpeechAudioBufferInfo',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'DISPID_SMSSetData',
    'SPEI_WORD_BOUNDARY', 'STSF_AppData', 'SAFTADPCM_11kHzStereo',
    'SPPS_RESERVED1', 'SpeechAllElements', 'SpeechVoiceSpeakFlags',
    'SDTAlternates', 'DISPID_SPIProperties',
    'ISpeechLexiconPronunciations', 'SAFTCCITT_uLaw_44kHzMono',
    'DISPID_SRGetPropertyNumber',
    'SpeechPropertyLowConfidenceThreshold', 'SPXMLRESULTOPTIONS',
    'DISPID_SPRFirstElement', 'DISPID_SABufferInfo', 'SVSFParseSapi',
    'SPPS_Verb', 'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SRCERecognitionForOtherContext',
    'SGDSActiveUserDelimited', 'SPSNotOverriden',
    'eLEXTYPE_LETTERTOSOUND', 'DISPID_SVSLastBookmarkId',
    'eLEXTYPE_APP', 'SpeechSpecialTransitionType',
    'eLEXTYPE_PRIVATE11', 'DISPID_SASetState', 'SPEI_RECOGNITION',
    'ISpPhrase', 'DISPID_SpeechPhraseInfo', 'DISPID_SLWsItem',
    'SPLOADOPTIONS', 'DISPID_SDKOpenKey', 'ISpEventSource',
    'ISpeechVoiceStatus', 'SAFT48kHz16BitMono', 'SPPHRASEELEMENT',
    'SPSHT_NotOverriden', 'SRSActiveAlways', 'DISPID_SOTs_NewEnum',
    'DISPID_SVSRunningState', 'SpPhoneConverter',
    'DISPID_SpeechBaseStream', 'ISpeechLexiconWord',
    'SPEVENTSOURCEINFO', 'SDA_Two_Trailing_Spaces',
    'eLEXTYPE_RESERVED7', 'DISPID_SVVolume', 'SECFIgnoreKanaType',
    'SPAS_CLOSED', 'SREAdaptation', 'DISPID_SPEAudioSizeTime',
    'SSFMOpenForRead', 'SpeechGrammarState',
    'SpeechCategoryRecoProfiles', 'SpeechDictationTopicSpelling',
    'SPEI_SR_RETAINEDAUDIO', 'ISpeechAudioStatus',
    'SpeechCategoryAppLexicons', 'DISPID_SPRsItem',
    'SpeechAudioState', 'Speech_Default_Weight', 'SGRSTTDictation',
    'SAFT24kHz16BitMono', 'SAFT48kHz8BitMono',
    'SpeechEngineProperties', 'SAFT16kHz8BitMono', 'SVP_15',
    'SpeechLoadOption', 'tagSTATSTG', 'SVSFIsNotXML',
    'ISpeechLexiconWords', 'ISequentialStream',
    'DISPID_SRGCmdLoadFromMemory', 'eLEXTYPE_PRIVATE1',
    'DISPID_SPRNumberOfElements', 'SPEI_SOUND_END', 'SP_VISEME_0',
    'SPEI_START_INPUT_STREAM', 'DISPID_SAVolume', 'SPSModifier',
    'SPCS_ENABLED', 'SRESoundStart', 'SAFT22kHz8BitMono',
    'DISPID_SpeechGrammarRule', 'SPINTERFERENCE',
    'DISPID_SRRRecoContext', 'SpWaveFormatEx',
    'DISPID_SpeechCustomStream', 'SAFTADPCM_44kHzMono',
    'DISPID_SRIsShared', 'DISPID_SPAStartElementInResult',
    '_SPAUDIOSTATE', 'SpeechRuleAttributes',
    'DISPID_SASCurrentSeekPosition', 'SP_VISEME_1',
    'SPINTERFERENCE_TOOLOUD', 'SGPronounciation',
    'DISPID_SVEAudioLevel', 'DISPID_SPRuleEngineConfidence',
    'SAFTADPCM_22kHzMono', 'DISPID_SRCERequestUI', 'SDTAll',
    'eLEXTYPE_PRIVATE18', 'SpStreamFormatConverter',
    'DISPID_SpeechPhraseElements', 'SpeechPartOfSpeech',
    'SPEVENTENUM', 'ISpProperties', 'SpeechRecoContextState',
    'SPVPRIORITY', 'DISPID_SRCCreateGrammar',
    'SAFTCCITT_ALaw_44kHzStereo', 'SAFT16kHz8BitStereo',
    'DISPID_SRGDictationSetState', 'DISPID_SVSpeak',
    'SECNormalConfidence', 'DISPID_SDKGetlongValue', 'SVEViseme',
    'SPRECOGNIZERSTATUS', 'IInternetSecurityManager',
    'SECFEmulateResult', 'SP_VISEME_2', 'SVPNormal', 'SPLO_DYNAMIC',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SBSWrite',
    'SpeechCategoryRecognizers', 'DISPID_SPEAudioTimeOffset',
    'SREStreamEnd', 'SSTTTextBuffer', 'DISPID_SPIAudioSizeBytes',
    'ISpeechPhraseReplacements', 'SPRST_INACTIVE', 'SVP_21',
    'SSFMOpenReadWrite', 'SAFTCCITT_ALaw_11kHzStereo',
    'DISPID_SRCState', 'DISPID_SRCEEnginePrivate', 'DISPID_SVRate',
    'SPAS_RUN', 'SLTApp', 'SITooFast', 'eLEXTYPE_PRIVATE3',
    'SPSHORTCUTPAIR', 'SPFM_NUM_MODES', 'SDA_Consume_Leading_Spaces',
    'SVEPhoneme', 'SRSInactive', 'SPSUnknown', 'SpNullPhoneConverter',
    'DISPID_SRGId', 'DISPID_SVIsUISupported', 'SPRECOCONTEXTSTATUS',
    'DISPID_SVEventInterests', 'tagSPTEXTSELECTIONINFO',
    'DISPID_SRRTLength', 'SPBO_PAUSE', 'SPEI_REQUEST_UI',
    'DISPID_SPIReplacements', 'SPPS_Unknown', 'DISPID_SPAPhraseInfo',
    'DISPID_SRAudioInputStream', 'SPEI_VISEME', 'SVSFIsFilename',
    'SPWORDPRONOUNCEABLE', 'SPPHRASEPROPERTY', 'eLEXTYPE_PRIVATE20',
    'SpObjectToken', 'DISPID_SPIAudioSizeTime', 'DISPID_SRRecognizer',
    'STCAll', 'DISPID_SOTCEnumerateTokens', 'SRTEmulated',
    'DISPID_SRGDictationUnload', 'SAFTTrueSpeech_8kHz1BitMono',
    'DISPIDSPRG', 'SpeechAddRemoveWord', 'ISpRecoContext',
    'DISPID_SPRuleFirstElement', 'SREPropertyStringChange',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SVStatus', 'SPEI_UNDEFINED',
    'ISpeechRecoGrammar', 'DISPID_SLGenerationId',
    'STSF_LocalAppData', 'SP_VISEME_8', 'SDTRule',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SREAllEvents',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SAFT12kHz16BitMono',
    'SpeechGrammarTagWildcard', 'ISpNotifyTranslator',
    'DISPID_SPACommit', 'SAFTExtendedAudioFormat',
    'SAFT16kHz16BitMono', 'DISPID_SVAudioOutputStream', 'SPCT_SLEEP',
    'DISPID_SVSInputWordPosition', 'ISpRecoResult', 'SPXRO_SML',
    'DISPID_SABufferNotifySize', 'ISpeechMemoryStream',
    'DISPID_SRCCmdMaxAlternates', 'SGRSTTRule', 'SVSFParseSsml',
    'SAFTCCITT_ALaw_11kHzMono', 'SAFTADPCM_22kHzStereo',
    'ISpObjectTokenCategory', 'SGRSTTWildcard', 'SGDisplay',
    'ISpeechMMSysAudio', 'DISPID_SGRSTPropertyId',
    'DISPID_SLAddPronunciation', 'SPVPRI_ALERT',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SpeechPhoneConverter',
    'eLEXTYPE_PRIVATE16', 'SVP_12', 'SpTextSelectionInformation',
    'SECFIgnoreCase', 'DISPID_SBSRead', 'DISPID_SpeechVoice',
    'SpeechDiscardType', 'SPCT_DICTATION',
    'DISPID_SAFSetWaveFormatEx', 'eLEXTYPE_RESERVED9',
    'SPRST_NUM_STATES', 'SpeechPropertyComplexResponseSpeed',
    'DISPID_SPEDisplayText', 'SRTStandard', 'SPDKL_LocalMachine',
    'DISPID_SCSBaseStream', 'Speech_StreamPos_RealTime',
    'SAFTDefault', 'SPRS_INACTIVE', 'SPDKL_DefaultLocation',
    'DISPID_SRGState', 'DISPID_SRProfile', 'SpeechAudioFormatType',
    'DISPID_SAFType',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'ISpObjectWithToken', 'SpStream', 'DISPID_SRGCmdSetRuleIdState',
    'SGDSActive', 'DISPID_SRCCreateResultFromMemory',
    'DISPID_SREmulateRecognition', 'SSSPTRelativeToCurrentPosition',
    'SPWORDLIST', 'DISPID_SRCRetainedAudioFormat',
    'DISPID_SPEPronunciation', 'SP_VISEME_5', 'SPSFunction',
    'SAFTADPCM_8kHzMono', 'DISPID_SVGetProfiles', 'DISPID_SRStatus',
    'SP_VISEME_14', 'DISPID_SPPsItem', 'SPSMF_SRGS_SAPIPROPERTIES',
    'DISPID_SpeechLexicon', 'DISPID_SVEViseme',
    'SWPKnownWordPronounceable', 'SpSharedRecognizer',
    'SPEI_RESERVED1', 'DISPID_SVSpeakStream',
    'DISPID_SVGetAudioInputs', 'DISPID_SRCreateRecoContext',
    'SpInprocRecognizer', 'SGSExclusive', 'SRSActive',
    'DISPID_SpeechGrammarRuleStateTransition', 'IStream',
    'ISpRecognizer2', 'SAFTADPCM_44kHzStereo', 'SpSharedRecoContext',
    'DISPID_SRCRetainedAudio', 'DISPID_SLPPhoneIds',
    'DISPID_SPAsCount', 'SPRS_ACTIVE_USER_DELIMITED',
    'DISPID_SGRAttributes', 'DISPID_SVSVisemeId', 'SREStreamStart',
    'SVEBookmark', 'SREPrivate', 'DISPID_SGRsCommitAndSave',
    'eLEXTYPE_PRIVATE7', 'DISPID_SPRDisplayAttributes',
    '_RemotableHandle', 'SP_VISEME_19', 'SPSMF_SAPI_PROPERTIES',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SRADefaultToActive', 'SPRECORESULTTIMES',
    'SPADAPTATIONRELEVANCE', 'SPGS_DISABLED', 'ISpeechResourceLoader',
    'eLEXTYPE_USER', 'DISPID_SGRsCommit', 'DISPID_SRCEAudioLevel',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SREPropertyNumChange',
    'SVEVoiceChange', 'DISPID_SVEVoiceChange', 'eLEXTYPE_RESERVED6',
    'SPINTERFERENCE_NONE', 'DISPID_SGRSRule', 'SPSEMANTICERRORINFO',
    'SPPS_Modifier', 'DISPID_SVAlertBoundary', 'DISPID_SPRulesCount',
    'DISPID_SRCESoundEnd', 'SPEI_END_INPUT_STREAM', 'SP_VISEME_16',
    'DISPID_SPIElements', 'SDTAudio', 'SDKLCurrentUser',
    'DISPID_SpeechObjectTokenCategory', 'SpNotifyTranslator',
    'DISPID_SAFGetWaveFormatEx', 'SPSHORTCUTPAIRLIST',
    'ISpeechPhraseInfo', 'DISPID_SFSClose', 'DISPID_SGRsFindRule',
    'SPVISEMES', 'SpAudioFormat', 'ISpNotifySource',
    'DISPID_SLWs_NewEnum', 'SPEI_PROPERTY_NUM_CHANGE',
    'DISPID_SRGRecoContext', 'SSTTWildcard', 'DISPID_SOTGetAttribute',
    'DISPIDSPTSI_SelectionLength', 'DISPID_SRCVoice', 'SVP_5',
    'DISPID_SABIBufferSize', 'SPEI_VOICE_CHANGE', 'SPEI_PHRASE_START',
    'eLEXTYPE_PRIVATE4', 'DISPID_SLWType', 'SPAUDIOSTATE',
    'DISPID_SPIGrammarId', 'SPINTERFERENCE_TOOSLOW', 'SPVPRI_OVER',
    'SVSFPurgeBeforeSpeak', 'SPPARTOFSPEECH', 'SPWAVEFORMATTYPE',
    'SVSFPersistXML', 'SAFT32kHz8BitMono', 'ISpeechRecognizerStatus',
    'DISPID_SpeechPhraseReplacement', 'SPINTERFERENCE_NOSIGNAL',
    'SVP_1', 'SPPS_RESERVED3', 'DISPID_SPEAudioStreamOffset',
    'eLEXTYPE_PRIVATE14', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SVSInputSentenceLength', 'DISPID_SRGetRecognizers',
    'SpeechGrammarTagDictation', 'SPGRAMMARSTATE',
    'ISpeechAudioFormat', 'DISPID_SpeechWaveFormatEx',
    'DISPID_SPPBRestorePhraseFromMemory', 'DISPID_SpeechLexiconWords',
    'DISPID_SOTCSetId', 'SPPS_SuppressWord', 'SPAO_RETAIN_AUDIO',
    'DISPID_SPEAudioSizeBytes', 'SSTTDictation', 'DISPID_SPRsCount',
    'DISPID_SRCAudioInInterferenceStatus', 'SSFMCreateForWrite',
    'SPGS_ENABLED', 'DISPID_SRRAudioFormat', 'ISpPhraseAlt',
    'DISPID_SpeechVoiceStatus', 'DISPID_SPPEngineConfidence',
    'SpeechTokenValueCLSID', 'SVSFVoiceMask', 'SAFT24kHz16BitStereo',
    'SpPhraseInfoBuilder', 'SpeechWordType', 'eLEXTYPE_PRIVATE12',
    'DISPID_SWFEBlockAlign', 'DISPID_SPCLangId',
    'DISPID_SPERequiredConfidence', 'SPSMF_UPS', 'SAFT32kHz16BitMono',
    'DISPID_SVPause', 'SGRSTTWord',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SPAR_Low',
    'SPGS_EXCLUSIVE', 'DISPID_SGRsItem', 'SP_VISEME_9',
    'DISPID_SGRSAddWordTransition', 'SPEI_SOUND_START',
    'DISPID_SLPLangId', 'DISPID_SpeechRecoResult2',
    'SpeechRecoProfileProperties', 'SPEI_TTS_AUDIO_LEVEL',
    'DISPID_SRSCurrentStreamPosition',
    'ISpeechGrammarRuleStateTransition', 'eLEXTYPE_PRIVATE9',
    'DISPID_SPERetainedSizeBytes', 'SVP_16', 'DISPID_SPCPhoneToId',
    'DISPID_SRCEventInterests', 'SAFT48kHz8BitStereo',
    'DISPID_SpeechRecoContext', 'DISPID_SPPId', 'SpMMAudioOut',
    'DISPID_SpeechAudio', 'DISPID_SGRSTRule', 'SPRST_ACTIVE_ALWAYS',
    'DISPID_SDKEnumValues', 'SPWT_PRONUNCIATION',
    'DISPID_SOTRemoveStorageFileName', 'SPSHT_OTHER',
    'ISpeechPhraseRule', 'SVP_19',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SAFT44kHz8BitMono',
    'SPAR_Unknown', 'SPEI_SR_AUDIO_LEVEL',
    'ISpeechRecoResultDispatch', 'SPWORD',
    'DISPID_SRSetPropertyNumber', 'DISPID_SRCERecognition',
    'DISPID_SPIRule', 'SpeechGrammarWordType', 'SAFT8kHz16BitStereo',
    'SPRULESTATE', 'DISPID_SRCEHypothesis', 'DISPID_SLWLangId',
    'SLODynamic', 'SVSFParseAutodetect', 'ISpXMLRecoResult',
    'DISPID_SWFESamplesPerSec', 'STCLocalServer', 'SPPROPERTYINFO',
    'DISPIDSPTSI_ActiveLength', 'DISPID_SPIEnginePrivateData',
    'SAFT44kHz16BitMono', 'DISPID_SLWPronunciations',
    'SAFT16kHz16BitStereo', '_ISpeechRecoContextEvents',
    'DISPID_SpeechDataKey', 'SPEI_SR_PRIVATE', 'SPEI_END_SR_STREAM',
    'DISPID_SpeechAudioStatus', 'DISPID_SVSkip', 'SRATopLevel',
    'DISPID_SVResume', 'DISPID_SASFreeBufferSpace',
    'DISPID_SPIStartTime', 'SPTEXTSELECTIONINFO', 'SPEI_MAX_SR',
    'DISPID_SRAudioInput', 'SPEI_FALSE_RECOGNITION', 'ISpVoice',
    'SpeechTokenShellFolder', 'SRAONone', 'DISPID_SPRs_NewEnum',
    'SRCS_Disabled', 'DISPID_SVWaitUntilDone', 'SPEI_RESERVED6',
    'SpeechTokenKeyAttributes', 'SRSEDone', 'IEnumSpObjectTokens',
    'SpVoice', 'SpeechStreamFileMode', 'SpPhoneticAlphabetConverter',
    'DISPID_SLWWord', 'SPEI_RESERVED2', 'SPPS_Noncontent',
    'SAFT24kHz8BitStereo', 'SVF_None', 'DISPID_SpeechLexiconWord',
    'DISPID_SLRemovePronunciation', 'SPEI_MIN_SR', 'SVP_6',
    'SAFT44kHz8BitStereo', 'SpeechVoiceCategoryTTSRate',
    'DISPID_SRCResume', 'DISPID_SMSALineId',
    'DISPID_SGRSTPropertyName', 'SRESoundEnd', 'SDKLCurrentConfig',
    'SpeechVoiceEvents', 'SPRECOSTATE', 'SVP_17',
    'SSSPTRelativeToEnd', 'SAFT11kHz8BitStereo',
    'DISPID_SPEDisplayAttributes', 'eLEXTYPE_PRIVATE10',
    'DISPID_SPPs_NewEnum', 'DISPID_SVSLastResult', 'SP_VISEME_12',
    'DISPID_SpeechFileStream', 'SP_VISEME_15',
    'SpObjectTokenCategory', 'DISPID_SASNonBlockingIO',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SGRId',
    'SAFTCCITT_uLaw_8kHzStereo', 'SPLO_STATIC', 'SRSEIsSpeaking',
    'DISPID_SpeechRecoResultTimes', 'SPPS_Noun',
    'DISPID_SPPFirstElement', 'SPCATEGORYTYPE', 'SPAR_High',
    'SWTDeleted', 'SPEI_TTS_PRIVATE', 'DISPID_SPRuleParent',
    'SpeechAudioProperties', 'SPSInterjection',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SpeechMemoryStream',
    'ISpeechPhraseElement', 'STCInprocHandler', 'SRERecoOtherContext',
    'SPGRAMMARWORDTYPE', 'eLEXTYPE_PRIVATE13', 'SVSFUnusedFlags',
    'SPAO_NONE', 'SPINTERFERENCE_TOOQUIET', 'DISPID_SGRClear',
    'SGRSTTTextBuffer'
]
